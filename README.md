...
2.  **Зробіть копію (Fork) репозиторію:**
    ...
    *   У правому верхньому кутку сторінки знайдіть і натисніть кнопку **Fork** `[Див. Малюнок: Кнопка Fork у верхньому правому кутку]`.
...
3.  **Запустіть робоче середовище (Codespace):**
    *   На сторінці вашої копії репозиторію натисніть велику зелену кнопку **Code** `[Див. Малюнок: Зелена кнопка Code]`.
    *   Перейдіть на вкладку **Codespaces**.
    *   Натисніть кнопку **Create codespace on main** `[Див. Малюнок: Кнопка Create codespace on main]`.
